function [pp,l_b2b3,l_3,l_5,R2,l_1,theta_1,L_2,L_1,R1,n_int,np_int,theta_45,theta_Tem3,theta_rot] = para(x)
%% Seven basic sizes
...
theta_45 = r/(R1+r) + asin(l_1*sin(theta_1)/(R1+r));
%% On flat ground
...
pp = forw*R2 - r*4*(theta_Tem3-theta_rot);
